...
public class BringSimilarForInsert extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>");
               out.println("<head><title>InsertSimilar</title></head>");
               out.println("<body>");
               out.println("<p><u>INSERT SIMILAR INVOICE</u></p>");
               out.println("<form name=\"InsertSimilarForm\" action=\"insertinvoice\" method=\"get\">");
